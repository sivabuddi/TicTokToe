...
class AutoTicTocToe():
    ...
    def autoPlay(self):
        ...
        for cell in range(9):
            if (not ((cell + 1 in p1) or (cell + 1 in p2))):
                Empty.append(cell + 1)
        try:
            RandIndex = random.randint(0, len(Empty) - 1)
            self.buttonClick(Empty[RandIndex])
        except:
            pass
    ...
    def drawGridLines(self, f1=False, f2=False, f3=False, f4=False, f5=False, f6=False, f7=False, f8=False, f9=False):
        ...
        if f2 == True:
            b2.config(command=lambda: self.autoPlay())
        ...
        if f4 == True:
            b4.config(command=lambda: self.autoPlay())
        ...
        if f6 == True:
            b6.config(command=lambda: self.autoPlay())
        ...
        if f8 == True:
            b8.config(command=lambda: self.autoPlay())
        ...
        Button(text="New Game..", font=('ubuntu', 28, 'bold'), bg='green', fg='white', border=5, width=4,
               command=lambda: self.restart()).grid(row=0, column=1, sticky="we")
...
if __name__ == '__main__':
    g = AutoTicTocToe()
    g.drawGridLines(f1=True, f2=True, f3=True, f4=True, f5=True, f6=True, f7=True, f8=True, f9=True)
