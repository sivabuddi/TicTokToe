...
class Board():
    ...
    def drawGridLines(self, f1=False, f2=False, f3=False, f4=False, f5=False, f6=False, f7=False, f8=False, f9=False):
        ...
        Button(text="New Game", font=('ubuntu', 28, 'bold'), bg='green', fg='white', border=5, width=4, command=lambda: self.restart()).grid(row=0, column=1, sticky="we")
...
if __name__ == '__main__':
    g = Board()
    g.drawGridLines()
    g.drawGridLines(f1=True,f5=True)
